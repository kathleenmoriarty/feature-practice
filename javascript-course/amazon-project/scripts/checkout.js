...
function updateCartQuantity() {
    ...
    cartQuantity === 1 ? document.querySelector('.js-return-to-home-link').innerHTML = `1 item` : document.querySelector('.js-return-to-home-link').innerHTML = `${cartQuantity} items`;
}
